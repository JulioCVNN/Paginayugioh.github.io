...
<!----Cuadros de texto del foro--->


<div class="letreroforo">
...
<div class="fondo">
  <div class="grid-container2">
    ...
    <div class="cuadronegro">
       <div class="contenido">
        <h2 class="Titulof">Que opinan sobre esto?</h2>
           <p class="Info">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam nec augue ut magna consequat elementum. Fusce non consequat orci. Vivamus vel facilisis quam. Proin varius</p>
           <img src="Images/u1.png" alt="">
           <p class="Creador">Created by: Usuario Yesterday at 13:07</p>
       </div>
        <button class="botonf"  type="submit">Ver mas</button>
    </div>
    </div>
